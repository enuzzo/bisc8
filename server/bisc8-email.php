...
<tr><td style="background:#000;padding:14px 18px;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
    <td style="font-family:{$PXF};color:#fff;font-size:22px;font-weight:700;letter-spacing:2px;"><img src="cid:bisc8logo" width="22" height="22" alt="Bisc8" style="vertical-align:middle;margin-right:9px;background:#fff;">BISC8<span style="font-family:{$MNF};font-size:11px;letter-spacing:2px;">  &middot; {$badge}</span></td>
