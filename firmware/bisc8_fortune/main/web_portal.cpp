...
.mascot{background:url(data:image/png;base64,) center/contain no-repeat;display:inline-block;image-rendering:pixelated;}
...
/* hero logo at the top of the portal — the cookie-wizard, hard-offset shadow */
.logo{display:block;width:10.5rem;max-width:60%;height:auto;margin:.7rem auto -.1rem;filter:drop-shadow(.2rem .26rem 0 var(--shadow));}
