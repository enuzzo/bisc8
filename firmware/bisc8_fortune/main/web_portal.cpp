...
const char *const kPortalRoutes[] = {
    ...
    "/api/reset",
    "/api/reboot",
    "/api/audio/question.wav",
    "/api/audio/answer.wav",
};
...
.mascot{background:url(data:image/png;base64,) center/contain no-repeat;display:inline-block;image-rendering:pixelated;}
...
/* group divs are the 2nd..7th div children of .wrap (status div is 1st): Wi-Fi=2 peach(default), Lingua=3, Oracolo=4, Email=5, Audio=6, Reset=7 */
...
.group:nth-of-type(6)>.glabel{background:var(--butter);} /* Audio */
.group:nth-of-type(7)>.glabel{background:var(--rose);}   /* Reset */
...
/* anchors styled as buttons (audio downloads) keep the same chunky look */
a.btn{display:inline-flex;align-items:center;justify-content:center;text-decoration:none;box-sizing:border-box;}
/* download rows: stacked, full width, System-7 list feel */
.actions.dl{flex-direction:column;align-items:stretch;}
  ...
  <div class="wrap">
    ...
    <div class="group">
      ...
      <form data-api="/api/openai">
        ...
        <div class="two">
          <div class="field"><label class="fld" data-i18n="tts">Testo a voce</label><input name="speech_model" data-fill="openai_speech_model" placeholder="gpt-4o-mini-tts"></div>
          <div class="field"><label class="fld" data-i18n="voice">Voce</label><select name="voice" data-fill="openai_voice"><option value="" data-i18n="voice_keep">(mantieni attuale)</option><optgroup label="Voci maschili / profonde"><option value="ash">maschile - ash, profonda</option><option value="ballad">maschile - ballad, teatrale</option><option value="cedar">maschile - cedar, naturale</option><option value="echo">maschile - echo, narrativo</option><option value="onyx">maschile - onyx, cavernosa</option><option value="sage">maschile - sage, calma</option><option value="verse">maschile - verse, poetica</option></optgroup><optgroup label="Voci femminili / chiare"><option value="coral">femminile - coral, calda</option><option value="marin">femminile - marin, naturale</option><option value="nova">femminile - nova, brillante</option><option value="shimmer">femminile - shimmer, luminosa</option></optgroup><optgroup label="Voci neutre / narrative"><option value="alloy">neutra - alloy, equilibrata</option><option value="fable">neutra - fable, narrativa</option></optgroup></select></div>
        </div>
    ...
    <div class="group">
      <span class="glabel" data-i18n="audio_label">Audio</span>
      <p class="hint" data-i18n="audio_hint">.</p>
      <div class="actions dl">
        <a class="btn sec" href="/api/audio/question.wav" download="bisc8-domanda.wav" data-i18n="audio_q">Domanda (mic)</a>
        <a class="btn sec" href="/api/audio/answer.wav" download="bisc8-risposta.wav" data-i18n="audio_a">Responso (voce)</a>
      </div>
    </div>
...
<div class="rebar" id="rebar">
  ...
  <div class="txt"><b data-i18n="reboot_title">Wi-Fi salvata.</b><span data-i18n="reboot_msg">Riavvia per provarla: l'esito appare sullo schermo.</span></div>
...
const I18N={
 ...
 audio_label:"Audio",audio_hint:"Le ultime registrazioni a piena qualità: la domanda che ha sentito il microfono e il responso pronunciato. Per controllare le orecchie del biscotto.",
 audio_q:"Domanda (mic)",audio_a:"Responso (voce)",
 ...
 reboot_title:"Wi-Fi salvata.",reboot_msg:"Riavvia per provarla: l'esito appare sullo schermo del biscotto.",reboot_now:"Riavvia ora",
 ...
 audio_label:"Audio",audio_hint:"The latest full-quality recordings: the question the mic heard and the spoken reading. For checking the biscuit's ears.",
 audio_q:"Question (mic)",audio_a:"Reading (voice)",
 ...
 reboot_title:"Wi-Fi saved.",reboot_msg:"Reboot to try it: the verdict shows on the biscuit's screen.",reboot_now:"Reboot now",
 ...
 rec_lbl:"Destinatario",relay_lbl:"Relay",
 audio_label:"Audio",audio_hint:"Las últimas grabaciones a plena calidad: la pregunta que oyó el micrófono y la lectura pronunciada. Para revisar los oídos de la galleta.",
 audio_q:"Pregunta (mic)",audio_a:"Lectura (voz)",
 ...
 reboot_title:"Wi-Fi guardada.",reboot_msg:"Reinicia para probarla: el resultado aparece en la pantalla de la galleta.",reboot_now:"Reiniciar ahora",
...
namespace {
// Both spool writers (mic capture and TTS) leave a canonical 44-byte PCM WAV
// header with patched sizes, so the data length at +40 is authoritative.
// Returns the full WAV byte count at base_offset, or 0 when nothing valid is there.
uint32_t SpoolWavTotalBytes(const esp_partition_t *spool, uint32_t base_offset) {
    if (spool == nullptr) {
        return 0;
    }
    uint8_t header[44] = {};
    if (esp_partition_read(spool, base_offset, header, sizeof(header)) != ESP_OK ||
        memcmp(header, "RIFF", 4) != 0 || memcmp(header + 8, "WAVE", 4) != 0 ||
        memcmp(header + 36, "data", 4) != 0) {
        return 0;
    }
    const uint32_t data_bytes = static_cast<uint32_t>(header[40]) |
                                (static_cast<uint32_t>(header[41]) << 8) |
                                (static_cast<uint32_t>(header[42]) << 16) |
                                (static_cast<uint32_t>(header[43]) << 24);
    const uint64_t total = 44ULL + data_bytes;
    if (data_bytes == 0 || data_bytes == 0xFFFFFFFFU ||
        base_offset + total > static_cast<uint64_t>(spool->size)) {
        return 0;
    }
...
esp_err_t WebPortal::StreamSpoolWav(httpd_req_t *req, uint32_t base_offset) {
    WebPortal *portal = PortalFromRequest(req);
    if (portal != nullptr) {
        portal->activity_ = true;  // a WAV pull counts as live config activity; don't sleep mid-download
    }
    const esp_partition_t *spool =
        esp_partition_find_first(ESP_PARTITION_TYPE_DATA, ESP_PARTITION_SUBTYPE_ANY, "spool");
    const uint32_t total = SpoolWavTotalBytes(spool, base_offset);
    if (total == 0) {
        return SendError(req, "404 Not Found", "No recording yet");
    }
    DebugSerial::LogAlways("[WEB]", "GET spool wav off=0x%x bytes=%u", static_cast<unsigned>(base_offset),
    ...
    while (remaining > 0) {
        ...
        if (httpd_resp_send_chunk(req, reinterpret_cast<const char *>(chunk), n) != ESP_OK) {
            return ESP_FAIL;  // client went away; httpd cleans the socket up
        }
        off += n;
        remaining -= n;
    }
...
esp_err_t WebPortal::HandleQuestionAudio(httpd_req_t *req) {
    // The live region (offset 0) is pre-erased right after each oracle flow;
    // fall back to the archived copy of the last question when it is gone.
    const esp_partition_t *spool =
        esp_partition_find_first(ESP_PARTITION_TYPE_DATA, ESP_PARTITION_SUBTYPE_ANY, "spool");
    if (SpoolWavTotalBytes(spool, 0) > 0) {
        return StreamSpoolWav(req, 0);
    }
    return StreamSpoolWav(req, kQuestionArchiveSpoolOffset);
}

esp_err_t WebPortal::HandleAnswerAudio(httpd_req_t *req) {
    return StreamSpoolWav(req, kVoiceAnswerSpoolOffset);
}
...
esp_err_t WebPortal::Start() {
    ...
    // Generous socket timeouts: slow phones pull multi-hundred-KB WAVs from
    // /api/audio/*, and historically tight timeouts made portal responses die
    // mid-flight (which looked like "no feedback / reboot" to the user).
    ...
    if (err == ESP_OK) {
        err = RegisterRoute("/api/audio/question.wav", HTTP_GET, &WebPortal::HandleQuestionAudio);
    }
    if (err == ESP_OK) {
        err = RegisterRoute("/api/audio/answer.wav", HTTP_GET, &WebPortal::HandleAnswerAudio);
    }
