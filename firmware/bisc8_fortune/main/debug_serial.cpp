...
void command_task(void *) {
    ...
    for (;;) {
        ...
        if (strcmp(line, "DEBUG 1") == 0) {
            ...
            DebugSerial::LogAlways("[SERIAL]", "commands: DEBUG 0, DEBUG 1, STATUS, SNAP, FORTUNE, MIC, VOICE START, VOICE STOP, WIFI SETUP, WIFI RESET, CONFIG RESET, SCREEN NOWIFI|LOWBATT|FIRSTRUN|SPEAK|LOWPOWER|STATUS|CONNFAIL|ERROR|LISTENING|THINKING|WIFISETUP, HELP");
