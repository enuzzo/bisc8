...
This folder is a static public flashing page for GitHub Pages or any HTTPS host. The canonical Pages source lives in `docs/`; the deployed `gh-pages` branch is generated from that folder and currently publishes firmware `r0142-20260624-1553`. It uses ESP Web Tools and a manifest with the ESP32-C6 ESP-IDF offsets:
